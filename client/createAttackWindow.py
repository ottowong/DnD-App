...
class mainFormDlg(QDialog) :
    ...
    def save(self):
        ...
        data=[17,self.parent().parent().username,self.parent().parent().password,name,proficient,toHitStat,toHitMod,dmgDice,dmgStat,dmgMod,self.parent().currentClickedCharacterId]
