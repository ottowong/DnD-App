...
class mainFormDlg(QDialog) :
    ...
    def updateLabels(self):
        data=[13,self.parent().parent().username,self.parent().parent().password,self.parent().attackToEdit]
    ...
    def save(self):
        ...
        data=[15,self.parent().parent().username,self.parent().parent().password,name,proficient,toHitStat,toHitMod,dmgDice,dmgStat,dmgMod,self.parent().attackToEdit]
        self.tcp_client = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
