...
class mainFormDlg(QDialog) :
    ...
    def updateStuff(self):
        data=[42,self.parent().parent().username,self.parent().parent().password,self.gameId,self.combatId]
    ...
    def loginClicked(self):
        ...
        data=[43,self.parent().parent().username,self.parent().parent().password,monsterIds,self.combatId]
        self.tcp_client = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    ...
    def __init__(self, parent= None) :
        ...
        self.setWindowTitle('Add Character to Combat')
        self.centerOnScreen()
